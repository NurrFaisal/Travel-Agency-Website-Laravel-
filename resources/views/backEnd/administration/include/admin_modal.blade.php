<div class="row">
    <div class="col-md-6 col-sm-6">
        <button data-target="#form-dialog-sub" data-toggle="modal" class="btn pmd-ripple-effect btn-primary pmd-z-depth pmd-ripple-effect " type="button">Admin Registration</button>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header bordered">
                        ...
                        <h2 class="pmd-card-title-text">Admin Registration</h2>
                    </div>
                    <div class="modal-body">

                        <form action="{{URL::to('/apanel/register-admin')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                                        ...
                                        <div class="pmd-card-body">
                                            ...
                                            <div class="form-group">
                                                <label class="radio-inline pmd-radio">
                                                    <input type="radio" name="admin" id="inlineRadio1" value="1">
                                                    <span for="inlineRadio1">Super Admin</span> </label>
                                                <label class="radio-inline pmd-radio">
                                                    <input type="radio" name="admin" id="inlineRadio2" value="2" >
