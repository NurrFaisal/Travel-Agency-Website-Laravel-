                                        ...
                                        <div class="pmd-card pmd-z-depth pmd-card-custom-form">
                                            <div class="pmd-card-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="regular1" value="{{$visa->country_name}}" class="form-control" name="country_name">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="regular1" value="{{$visa->price}}" class="form-control" name="price">
                                                </div>
                                                @if ($errors->has('price'))
                                                    <span class="invalid-feedback" role="alert">
                                            ...
                                            <strong style="color: red">{{ $errors->first('short_description') }}</strong>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="{{$visa->duration}}"  class="form-control" name="duration">
                                                </div>
