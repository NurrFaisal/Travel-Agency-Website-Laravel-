<div class="row">
    <div class="col-md-6 col-sm-6">
        <button data-target="#form-dialog-sub" data-toggle="modal" class="btn pmd-ripple-effect btn-primary pmd-z-depth pmd-ripple-effect " type="button">Add Year</button>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header bordered">
                        ...
                        <h2 class="pmd-card-title-text">Add Year</h2>
                    </div>
                    <div class="modal-body">

                        <form action="{{URL::to('/apanel/gallery/add-year')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                                    ...
                                    <div class="pmd-card pmd-z-depth pmd-card-custom-form">
                                        <div class="pmd-card-body">
                                            ...
                                            <div class="form-group">
                                                <label for="regular1" class="control-label">year</label>
