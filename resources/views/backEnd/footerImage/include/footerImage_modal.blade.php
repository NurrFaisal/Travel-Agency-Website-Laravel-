<div class="row">
    <div class="col-md-6 col-sm-6">
        <button data-target="#form-dialog-slider" data-toggle="modal" class="btn pmd-ripple-effect btn-primary pmd-z-depth pmd-ripple-effect " type="button">Add Footer Image</button>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header bordered">
                        ...
                        <h2 class="pmd-card-title-text">Add Footer Image</h2>
                    </div>
                    <div class="modal-body">

                        <form action="{{URL::to('/add-footerImage')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="pmd-card pmd-z-depth pmd-card-custom-form">
                                        ...
                                        @endif
                                            <div class="form-group">
                                                <label for="regular1" class="control-label">Footer Image</label>
