                                    ...
                                    <div class="col-md-12">
                                        <div class="pmd-card pmd-z-depth pmd-card-custom-form">
                                            <div class="pmd-card-body">
                                                ...
                                                <div class="form-group">
                                                    <label for="regular1" class="control-label">Embssy Fee</label>
                                                    <input required type="text" id="regular1" value="{{$visa->embassy_fee}}" class="form-control" name="embassy_fee">
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input required type="text" id="regular1" value="{{$visa->cosmos_fee}}" class="form-control" name="cosmos_fee">
                                                </div>
