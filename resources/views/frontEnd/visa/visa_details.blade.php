...
{{--                            update 10.09.19 for embassy price and proceing price star--}}
                            ...
                            <div class="dir-rat-inn dir-rat-review">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 dir-rat-right">
                                        <div class="col-md-6">
{{--                                            <div class="dir-rat-star"><h4>Embassy Fee : BDT 5000/=</h4></div>--}}
                                            <div class="dir-rat-star" style="color: #0e76a8;"><h4>Embassy Fee : BDT {{$visa_detail->embassy_fee}}/=</h4></div>
                                        </div>
                                        <div class="col-md-6">
{{--                                            <div class="dir-rat-star"><h4>Our Procesing Fee : BDT 5000/=</h4></div>--}}
                                            <div class="dir-rat-star" style="color: #0e76a8; float: right"><h4>Our Procesing Fee : BDT {{$visa_detail->cosmos_fee}}/=</h4></div>
                                        </div>
                                    </div>
                                </div>
                            </div>

{{--                            update 10.09.19 for embassy price and proceing price end--}}
