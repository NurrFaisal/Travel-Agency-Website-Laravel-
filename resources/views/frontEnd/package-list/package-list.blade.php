...
@section('title') {{$packList->name}} List  {{$division->name}}, {{$country->name}} @endsection
@section('mainContent')
    ...
    <section class=" hot-page2-pa-sp-top" style="background-image: url({{asset($division->background_image)}}); background-size: cover">
        <div class="container">
            <div class="row inner_banner inner_banner_3 bg-none" >
                <div class="hot-page2-alp-tit">
                    <h1>{{$packList->name}} List  {{$division->name}}, {{$country->name}}</h1>
                    {{--<ul>--}}
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="{{URL::to('/package-detail/'.$releted_package->id)}}">
                                        <div class="hot-page2-hom-pre-1 hot-page2-alp-cl-1-1"> <img src="{{asset($releted_package->box_image)}}" alt="{{$releted_package->name}}"> </div>
