...
@section('title') {{$packList->name}} @endsection
@section('mainContent')
    <style>
        .inner_banner::before {
            content: '';
    ...
    <!--====== PLACES ==========-->
    <section>
        <div class="rows inn-page-bg" style="background-image: url({{asset($packList->background_image)}}); background-size: cover;">
            <div style="background-color: transparent" class="container inn-page-con-bg tb-space pad-bot-redu" id="inner-page-title">
                <!-- TITLE & DESCRIPTION -->
                <div class="spe-title col-md-12">
                    <h2 style="color: white">{{$packList->name}}</h2>
                ...
                <div>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 b_packages zm wow fadeInUp">
                        ...
                        <a href="{{URL::to('/package-country/'.$continent->id.'/'.$packList->id)}}">
                            <div class="zm">
                                ...
                                <div class="b_pack rows sw" style="background-color: #cde9ebf0;">
                                    <div class="col-md-12" style="text-align: center">
                                        <h4 ><a href="{{URL::to('/package-country/'.$continent->id.'/'.$packList->id)}}"><strong>{{$continent->name}}</strong></a> </h4> </div>
                                </div>
                            </div>
                        </a>
                    </div>
