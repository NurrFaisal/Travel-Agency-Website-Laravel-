                ...
                <div>
                    ...
                    @foreach($countries as $country)
                        <div class="col-md-3 col-sm-6 col-xs-12 b_packages zm wow fadeInUp">
                            ...
                            <a href="{{URL::to('/search-country-package/'.$country->id)}}">
                                <div class="zm">
                                    ...
                                    <div class="b_pack rows sw" style="background-color: #cde9ebf0;">
                                        <div class="col-md-12" style="text-align: center">
                                            <h4 ><a href="{{URL::to('/search-country-package/'.$country->id)}}"><strong>{{$country->name}}</strong></a> </h4> </div>
                                    </div>
                                </div>
                            </a>
                        </div>
