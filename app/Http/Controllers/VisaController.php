...
class VisaController extends Controller
{
    ...
    public function visaCountry(){
        $con_visas = Visa::orderBy('country_name', 'asc')->where('status', 1)->select('country_name', 'price', 'id', 'box_image')->get();
        return view('frontEnd.visa.visa', ['con_visas' => $con_visas]);
    }
    ...
    protected function saveVisaBasic($request, $visa){
        ...
        $visa->embassy_fee = $request->embassy_fee;
        $visa->cosmos_fee = $request->cosmos_fee;
